...
export const FEATURES = [
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="35" height="35" color="currentColor" fill="none" stroke="#141B34" stroke-width="1.5" stroke-linejoin="round">
    ...
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="35" height="35" color="#000000" fill="none" stroke="currentColor" stroke-width="1.5">
    ...
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="35" height="35" color="#000000" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
export const COURSE_CARDS = [
    ...
    },
    {
        ...
        name: '600 Essential Korean Words',
        tags: [
            { label: '600 từ', color: 'pink' },
            { label: '30 topics', color: 'pink' },
        ],
        desc: 'Bộ sách từ vựng tiếng Hàn phổ biến do nhóm Key to Korean biên soạn, gồm 600 từ chia theo 30 chủ đề, phù hợp cho người mới bắt đầu và nền tảng TOPIK I-II.',
        fillWidth: '45%',
